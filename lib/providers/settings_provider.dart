...
class SettingsProvider extends BaseProvider {
  ...
  Map<String, Map<String, String>> translations = {
    'en': {
      ...
      'editExpenseDetails': 'Update expense details',
    ...
    'is': {
      ...
      'endTime': 'Lokatími',
      'selectDateRange': 'Dagsetning',
      'allUsers': 'Allir notendur',
      'description': 'Lýsing',
      ...
      'sharedJobsPremiumFeature': 'Sameiginleg verk eru áskriftar eiginleiki',
      'upgradeToAccessSharedJobs':
      ...
      'invalidJobCode': 'Ógildur verkakóði',
      ...
      'sharedJobsSelectButton': 'Tengd verk',
      ...
      'profile': 'Prófíll',
      'noName': 'Ekkert nafn',
      'editProfile': 'Breyta nafni',
      'verify': 'Staðfesta',
      'verificationEmailSent': 'Staðfestingarpóstur sendur',
      'profileUpdated': 'Prófíll uppfærður',
      'accountCreated': 'Reikningur stofnaður',
      'emailNotVerified': 'Vinsamlegast staðfestu netfangið þitt',
      'timeEntries': 'Tímafærslur',
      'expenses': 'Gjöld',
      'addExpense': 'Bæta við',
      'expenseAdded': 'Gjaldi bætt við',
      'deleteExpense': 'Eyða gjaldi',
      'deleteExpenseConfirm': 'Ertu viss um að þú viljir eyða þessu gjaldi?',
      'expenseDeleted': 'Gjaldi eytt',
      'errorDeletingExpense': 'Villa við að eyða gjaldi',
      'errorUpdatingExpense': 'Villa við að uppfæra gjald',
      'expenseUpdated': 'Gjaldi uppfærð',
      'editExpense': 'Breyta gjaldi',
      'editExpenseDetails': 'Uppfæra upplýsingar gjald',
